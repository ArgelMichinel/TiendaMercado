            ...
            <div class="row">
              <div class="col-5 mx-auto">
                <form>
                  ...
                  <button type="button" id='Registrar' class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Modal</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Usuario creado con éxito</h4>
      </div>
...
document.getElementById("Registrar").onclick = function() {
  var formList = [].slice.call(document.querySelectorAll('.form-control'));
  var singin = [formList[1], formList[2], formList[3]];
  console.log(singin);

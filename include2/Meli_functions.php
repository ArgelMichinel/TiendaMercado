...
function Actualiz_prod($pdo, $producto, $imagen) {

    update($pdo, 'productos', 'id_producto', $producto);
    update($pdo, 'imagenes', 'id_producto', $imagen);
}
...
///////////////////////////////////////////////////////
function insert_product($pdo, $producto, $imagen) {
    insert($pdo, 'productos', $producto);
